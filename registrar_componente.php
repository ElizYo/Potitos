<?php
    ...
    $data_tipo_componente = get_tipo_componente();
        ...
        <div>
            <?php
                ...
                if(isset($_GET['success'])&& $_GET['success']==1){
                    echo '<h3>Su producto se registro correctamente.</h3>';
                } elseif(isset($_GET['errno']) && $_GET['errno']==1){
                    echo '<h3>Hubo un error al registro su producto.</h3>';
                }
            ?>
        </div>
            <form method="post" enctype="multipart/form-data" action="php/register_product.php">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="number" name="precio" step="000.01" id="precio">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="tipo_componente" id="tipo_componente">
                        <?php
                        foreach ($data_tipo_componente as $id_tipo_componente) {
                            echo '<option value="'.$id_tipo_componente['ID_TIPO_COMPONENTE'].'">'.$id_tipo_componente['NOMBRE'].'</option>';
                        }
                        ?>
                    </select>
                </div>
